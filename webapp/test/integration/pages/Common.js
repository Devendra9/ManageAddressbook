sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("myapp/product/Manageproduct/app", ".html");
		...
		return Opa5.extend("myapp.product.Manageproduct.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["myapp/product/Manageproduct/localService/mockserver"], function (mockserver) {
